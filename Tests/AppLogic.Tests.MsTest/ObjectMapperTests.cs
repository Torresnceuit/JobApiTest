...
public class ObjectMapperTests
{
    ...
    public void Map_Collection_ReturnsMappedCollection()
    {
        ...
        {
            new (Guid.NewGuid(), "name1", Guid.NewGuid()),
            new (Guid.NewGuid(), "name2", Guid.NewGuid())
        };
    ...
    {
        var source = new LegalMatter(Guid.NewGuid(), "name1", Guid.NewGuid());
    ...
    {
        var source = new DbLegalMatter(Guid.NewGuid(), "name1", Guid.NewGuid());
